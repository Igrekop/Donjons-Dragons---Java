...
public class Jeu {
    ...
    public void partie(Scanner scanner, ArrayList<entite> participants, List<Object> participants2,List<Joueur> joueurs, Maitredujeux mj, int numeroDonjon, map_milieu map) {
        ...
        participants.removeIf(participant -> participant instanceof Gobelin);
        participants.removeIf(participant -> participant instanceof Dragon);
        participants.removeIf(participant -> participant instanceof Squelette);
        participants.removeIf(participant -> participant instanceof Monstreperso);
        participants2.removeIf(participant -> participant instanceof Monstre);
        participants2.removeIf(participant -> participant instanceof Gobelin);
        participants2.removeIf(participant -> participant instanceof Dragon);
        participants2.removeIf(participant -> participant instanceof Squelette);
        participants2.removeIf(participant -> participant instanceof Monstreperso);
        if (numeroDonjon <= 3) {
